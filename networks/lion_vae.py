...
from .lion_distributions import Normal
from utils.lion_model_helper import loss_fn
...
class Model(nn.Module):
    ...
    def kl_coeff(self, step, total_step, constant_step, min_kl_coeff, max_kl_coeff):
    ...
    def get_loss(self, x, writer=None, it=None, ## weight_loss_1=1, 
        ...
        if self.args.trainer.anneal_kl and self.num_total_iter > 0: 
            global_step = it 
            kl_weight = self.kl_coeff(step=global_step,
